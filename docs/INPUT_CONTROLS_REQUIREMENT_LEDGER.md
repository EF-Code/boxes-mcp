...
| 8.1 | Confined canonical readable regular source | `src/transfer.ts`, native no-follow check | `src/transfer.test.ts` | Evidence doc | Live source/guest destination | IMPLEMENTED-UNVERIFIED-LIVE | b89910a, 7c97c11 |
| 8.2 | Async SPICE file copy/progress/cancellable/timeout/bytes | Native file-copy callbacks | native build/local helper; transfer tests | Protocol/evidence docs | Live transfer | IMPLEMENTED-UNVERIFIED-LIVE | b89910a, 7c97c11 |
