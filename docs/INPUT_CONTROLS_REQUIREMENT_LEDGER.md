...
| 7.5 | Round trips and disconnected-agent error | Opt-in harness and manual env gate | `src/integration.test.ts` | README instructions | Both directions; manual agent disconnect | BLOCKED-LIVE | 9b7d77e; Omarchy has no clipboard capability, and manual disconnect was not staged |
