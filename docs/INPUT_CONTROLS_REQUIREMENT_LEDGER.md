...
| 5.5 | Timeouts/cancellation/channel lifecycle/reconnect/crash handling | TS pending map; native cancellable/session cleanup | spice lifecycle tests | README troubleshooting | Real disconnect/reconnect | IMPLEMENTED-UNVERIFIED-LIVE | 38561cd, e01dd47, 0b91744, 11dd125; async transfer requests retain ownership through cancellation callbacks |
